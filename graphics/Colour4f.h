...
public:
	...
	GLARE_STRONG_INLINE Colour4f& operator = (const Colour4f& a);

	GLARE_STRONG_INLINE float& operator [] (size_t index);
	GLARE_STRONG_INLINE const float& operator [] (size_t index) const;

	GLARE_STRONG_INLINE void operator += (const Colour4f& a);
	GLARE_STRONG_INLINE void operator *= (const Colour4f& a);
	GLARE_STRONG_INLINE void operator -= (const Colour4f& a);
	...
	GLARE_STRONG_INLINE void addMult(const Colour4f& a, float x);
	GLARE_STRONG_INLINE void clampInPlace(float lowerbound, float upperbound);
	GLARE_STRONG_INLINE void lowerClampInPlace(float lowerbound);
	
	GLARE_STRONG_INLINE float length() const;
	GLARE_STRONG_INLINE float length2() const;
	GLARE_STRONG_INLINE float getDist(const Colour4f& a) const;
	GLARE_STRONG_INLINE float getDist2(const Colour4f& a) const;
	...
	GLARE_STRONG_INLINE bool isFinite() const;

	GLARE_STRONG_INLINE bool isZero() const;
...
GLARE_STRONG_INLINE Colour4f operator + (const Colour4f& a, const Colour4f& b)
{
...
GLARE_STRONG_INLINE Colour4f operator * (const Colour4f& a, float f)
{
...
GLARE_STRONG_INLINE float dot(const Colour4f& a, const Colour4f& b)
{
#if 1 // USE_SSE4 
	Colour4f res;
...
GLARE_STRONG_INLINE Colour4f min(const Colour4f& a, const Colour4f& b)
{
	return Colour4f(_mm_min_ps(a.v, b.v));
}


GLARE_STRONG_INLINE Colour4f max(const Colour4f& a, const Colour4f& b)
{
	return Colour4f(_mm_max_ps(a.v, b.v));
}


GLARE_STRONG_INLINE Colour4f clamp(const Colour4f& c, const Colour4f& lower, const Colour4f& upper)
{
	return min(max(c, lower), upper);
}


GLARE_STRONG_INLINE Colour4f normalise(const Colour4f& a)
{
	return a * (1.0f / a.length());
}


GLARE_STRONG_INLINE Colour4f normalise(const Colour4f& a, float& length_out)
{
	length_out = a.length();
...
GLARE_STRONG_INLINE Colour4f maskWToZero(const Colour4f& a)
{
	return Colour4f(_mm_and_ps(a.v, bitcastToVec4f(Vec4i(0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0)).v));
}


GLARE_STRONG_INLINE const Colour4f removeComponentInDir(const Colour4f& v, const Colour4f& dir)
{
...
// Unary -
GLARE_STRONG_INLINE const Colour4f operator - (const Colour4f& v)
{
	// Flip sign bits
...
GLARE_STRONG_INLINE Colour4f select(const Colour4f& a, const Colour4f& b, const Colour4f& mask)
{
	return Colour4f(_mm_blendv_ps(b.v, a.v, mask.v));
}


GLARE_STRONG_INLINE const Vec4i toVec4i(const Colour4f& v)
{
...
// SSE2
GLARE_STRONG_INLINE Colour4f toColour4f(const Vec4i& v)
{
	return Colour4f(_mm_cvtepi32_ps(v.v));
}


GLARE_STRONG_INLINE Colour4f bitcastToColour4f(const Vec4i& v)
{
	return Colour4f(_mm_castsi128_ps(v.v));
}


GLARE_STRONG_INLINE const Colour4f sqrt(const Colour4f& a)
{
	return Colour4f(_mm_sqrt_ps(a.v));
}


GLARE_STRONG_INLINE const Colour4f abs(const Colour4f& a)
{
	// Zero the sign bits.
...
GLARE_STRONG_INLINE Colour4f loadColour4f(const float* const data)
{
...
GLARE_STRONG_INLINE Colour4f loadUnalignedColour4f(const float* const data)
{
	return Colour4f(_mm_loadu_ps(data));
}


GLARE_STRONG_INLINE void storeColour4f(const Colour4f& v, float* const mem)
{
...
GLARE_STRONG_INLINE void storeColour4fUnaligned(const Colour4f& v, float* const mem)
{
...
GLARE_STRONG_INLINE const Colour4f swizzle(const Colour4f& a) { return Colour4f(_mm_shuffle_ps(a.v, a.v, _MM_SHUFFLE(index3, index2, index1, index0))); } // SSE 1


template<int index>
GLARE_STRONG_INLINE float elem(const Colour4f& v) { return _mm_cvtss_f32(swizzle<index, index, index, index>(v).v); } // SSE 1

template<>
GLARE_STRONG_INLINE float elem<0>(const Colour4f& v) { return _mm_cvtss_f32(v.v); } // Specialise for getting the zeroth element.
