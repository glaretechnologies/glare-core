...
struct GLMemUsage
{
	GLMemUsage() : geom_cpu_usage(0), geom_gpu_usage(0), texture_cpu_usage(0), texture_gpu_usage(0), sum_unused_tex_cpu_usage(0), sum_unused_tex_gpu_usage(0) {}
	...
	size_t sum_unused_tex_cpu_usage;
