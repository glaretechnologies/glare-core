...
#define FT_CONFIG_OPTION_USE_ZLIB
   ...
   */
#define FT_CONFIG_OPTION_SYSTEM_ZLIB // GLARE NEW: Use the existing zlib 
...
#define FT_CONFIG_OPTION_ADOBE_GLYPH_LIST
   ...
   */
// GLARE NEW #define FT_CONFIG_OPTION_MAC_FONTS
...
#define FT_CONFIG_OPTION_SVG
   ...
   */
  #define FT_CONFIG_OPTION_ERROR_STRINGS // GLARE NEW
