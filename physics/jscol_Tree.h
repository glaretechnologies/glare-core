...
public:
	...
	virtual Real traceRay(const Ray& ray, Real max_t, ThreadContext& thread_context/*, js::TriTreePerThreadData& context*/, const Object* object, unsigned int ignore_tri, HitInfo& hitinfo_out) const = 0;
